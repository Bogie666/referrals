...
- **ServiceTitan** — source of truth for jobs/customers. Polled every 2 hours during business hours via `cron.js`. Two custom fields are in play and they live on DIFFERENT records:
